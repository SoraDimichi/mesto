export class Card {
  ...
  _removeCard() {
    this._element.querySelector('.element__removeButton').addEventListener('click', () => {
      this._element.remove(this._element)
    })
  }

  _likeCard() {
    this._element.querySelector('.element__likeButton').addEventListener('click', () => {
      this._element
        .querySelector('.element__likeButton')
        .classList.toggle('element__likeButton_toggled')
    })
  }
  ...
  _handleCardClick() {
    this._element.querySelectorAll('.element__image, .element__title').forEach((el) => {
      el.addEventListener('click', (evt) => {
        if (evt.target !== this._element.querySelector('.element__removeButton')) {
